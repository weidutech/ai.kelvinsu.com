export const siteUrl = "https://ai.kelvinsu.com";
...
export const pageDescriptions: Record<string, string> = {
  "/": siteDescription,
  "/community/":
    "Kelvin AI Guide 的站点说明页，介绍本站定位、内容范围和后续可继续替换的品牌位。",
  "/community/roadmap.html":
    "关于 Kelvin AI Guide：说明这个站点模板的定位、当前保留内容，以及部署到自有品牌时建议优先替换的部分。",
  "/configuration/":
  ...
  "/guide/":
    "Kelvin AI Guide 学习路线目录，汇总入门准备、日常工作流、CLI、IDE、Cloud、AGENTS.md 和排障章节。",
  ...
  "/recipes/credits.html":
    "Kelvin AI Guide 参考来源与致谢，整理案例中涉及的第三方工具、官方文档、仓库链接和内容来源，便于追溯资料。",
