...
<p align="center">
  ...
  ·
  <a href="https://ai.kelvinsu.com/">在线阅读</a>
  ·
...
**Kelvin AI Guide 的在线阅读地址是 [ai.kelvinsu.com](https://ai.kelvinsu.com/)。**

<p align="center">
  <a href="https://ai.kelvinsu.com/">
    <img src="./assets/homepage-preview.png" alt="Kelvin AI Guide 网站首页预览" width="920" />
  </a>
</p>
...
如果你正在第一次接触 Codex，可以直接从网站的 [学习路线](https://ai.kelvinsu.com/guide/00-overview.html) 开始；如果你已经知道自己要用 CLI、桌面 App、Cloud 或 IDE，可以先看 [入口地图](https://ai.kelvinsu.com/platform/)。

## 项目愿景

Codex 正在从“帮你写代码的工具”，演进为一套覆盖 CLI、Cloud/Web、IDE extension、桌面 App、移动端协同、浏览器和自动化能力的 AI 工作流系统。

Kelvin AI Guide 想做的不是命令速查表，而是一份面向真实任务的实践知识库。它关注三个问题：
...
仓库里原作者的赞助商、公众号和群入口已经从站点模板里移除。这里建议你后续自行补充：

- 你的邮箱、公众号、社群入口或社媒主页。
- 你的赞助商、合作伙伴或 API 服务推荐位。
- 你的品牌介绍与免责声明。
...
默认开发服务会启动 VuePress 文档站。这个模板当前面向 [ai.kelvinsu.com](https://ai.kelvinsu.com/) 部署。
...
如果你准备把这个模板改成自己的品牌站，建议继续把 README 顶部标题、截图、徽章和项目说明统一替换成你自己的版本。

## 联系方式

这里建议替换成你自己的联系方式与社群入口，避免继续引用原作者信息。
